...
final class OrbitalUITests: XCTestCase {
    private struct LabServerSpec {
        let name: String
        let port: String
    }

    private let labServers: [LabServerSpec] = [
    ...
    private func openServerDetail(named serverName: String, in app: XCUIApplication) {
    ...
    private func ensureLabServerExists(named serverName: String, in app: XCUIApplication) {
    ...
    private func verifyLabServerCanPoll(named serverName: String, in app: XCUIApplication) {
    ...
    private func presentAddServer(in app: XCUIApplication) {
    ...
    private func createServer(_ server: LabServerSpec, in app: XCUIApplication) {
    ...
    private func tapPrimaryEditorAction(in app: XCUIApplication) {
    ...
    private func shouldClearCurrentValue(_ currentValue: String) -> Bool {
    ...
    private func serverRow(named serverName: String, in app: XCUIApplication) -> XCUIElement {
        app.descendants(matching: .any)
            .matching(identifier: serverRowIdentifier(for: serverName))
            .firstMatch
    }

    private func assertNoSaveFailure(in app: XCUIApplication) {
    ...
    private func assertNoConnectionError(in app: XCUIApplication, serverName: String) {
    ...
    private func revealMetricsGauge(_ diskGauge: XCUIElement, in app: XCUIApplication) {
    ...
    private func waitForElementToDisappear(_ element: XCUIElement, timeout: TimeInterval, failureMessage: String) {
    ...
    private func serverRowIdentifier(for serverName: String) -> String {
